...
<body>
    ...
    <main class="remind-page">
        <section class="page-header-block position-relative d-flex align-items-center justify-content-center" style="background-image: url(./assets/images/about-img.jpeg);">
            <div class="text-center page-header-content mt-5">
                <h1 class="position-relative text-white fs-1 fw-bold text-uppercase">Reminder</h1>
        ...
        <section class="remind-block py-5">
            <div class="w-50 mx-auto">
                <ul class="list-unstyled">
                    <li class="remind-item bg-white shadow rounded p-3 mb-3" style="cursor: pointer;">
                        <div class="d-flex align-items-center gap-2">
                            <div class="" style="width: 8%;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                                    <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4 4 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5 5 0 0 1 13 6c0 .88.32 4.2 1.22 6"/>
                                </svg>
                            </div>
                            <div class="remind-content" style="width: 80%;">
                                <h2 class="fs-4 fw-semibold lh-sm">Remind Title</h2>
                                <p class="fs-6 fw-normal lh-sm mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero vitae rerum minus molestias vel iusto ea mollitia in error perferendis.</p>
                            </div>
                            <div class="text-end" style="width: 12%;">
                                <p class="notification-time mb-0">3 hours ago</p>
                            </div>
                        </div>
                    </li>
                    <li class="remind-item bg-white shadow rounded p-3 mb-3" style="cursor: pointer;">
