    ...
    <main class="booking-page">
        <section class="page-header-block position-relative d-flex align-items-center justify-content-center" style="background-image:url({{asset('userside_assets/assets/images/about-img.jpeg')}});">
            <div class="text-center page-header-content mt-5">
                <h1 class="position-relative text-white fs-1 fw-bold text-uppercase">Your Booking</h1>
                    ...
                    <div class="col-12 bg-white rounded-3 shadow mb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8 p-3">
                                ...
                                <p class="card-price fs-6 fw-normal lh-sm mb-2 text-black">Price <span class="currency fw-semibold">130</span><span class="currency-symbol fw-semibold">$</span></p>
                                <p class="card-description fw-normal lh-sm mb-4 text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga iste a omnis, quaerat recusandae aut exercitationem incidunt, nobis, neque voluptatibus velit reiciendis temporibus saepe commodi natus.</p>
