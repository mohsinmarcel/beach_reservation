                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center mb-4">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder text-capitalize">Online Beach Seat
                                    Reservation Platform</span>
                            </a>
                        </div>
                        <h4 class="mb-2"></h4>
                        <p class="mb-4">Register Here To Become A Service Provider With This Platform</p>
                        <form id="tenantRegister" class="mb-3">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <label class="form-check-label" for="terms-conditions">I agree to <a
                            ...
                            <button type="button" class="btn btn-primary d-grid w-100" onclick="registerTenant(this)">Sign up</button>
                        </form>
                        <p class="text-center">
                            <span>Already have an account?</span>
                            <a href="{{route('tenant.login')}}"><span>Sign in instead</span></a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
     <script>
         function registerTenant() {
            var formData = new FormData($('#tenantRegister')[0]);
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                url: '{{ route('tenant.register.process') }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                error: function(xhr, status, error) {
                    ...
                    // Check if it's a Laravel validation error (422)
                    if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                        ...
                        $.each(errors, function(fieldName, messages) {
                            ...
                            if (input.length > 0) {
                                input.after('<small class="text-danger" style="color:red">' + messages[0] + '</small><br>');
                            }
                        });
                    } else {
