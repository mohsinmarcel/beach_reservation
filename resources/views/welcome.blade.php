            ...
            <div class="container-fluid p-0">
                <div class="hero-video">
                    <video autoplay  loop  preload="auto" muted tabindex="0" style="object-fit:cover;">
                        <source src="{{asset('userside_assets/assets/images/hero-vd.mp4')}}" type="video/mp4"> <!-- H.264 -->
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="fs-6 lh-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque feugiat ultrices consequat. Nunc et mauris sit amet enim dapibus dignissim eget eget orci. Nulla tincidunt erat et tempor faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc imperdiet dui neque, et congue lectus pellentesque in. Maecenas lacinia tortor turpis, vitae pulvinar sapien posuere eu. Cras ligula felis, efficitur vel nunc quis, tincidunt blandit sapien. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Donec at magna accumsan, porta mi ac, euismod tellus. Fusce eu tincidunt ante. Fusce ipsum arcu, luctus ac purus nec, tempus posuere felis.</p>
                        <p class="fs-6 lh-base">Nunc mi nibh, ornare eget cursus eu, ornare ut leo. Praesent accumsan, massa cursus facilisis laoreet, odio sapien fermentum turpis, ultrices laoreet mauris elit non nunc. Morbi vel nisi commodo, vulputate neque in, dapibus orci. Ut iaculis enim posuere rutrum tincidunt. Proin in nisi porta, vehicula tortor et, malesuada nunc. Nullam elementum ipsum at sollicitudin fermentum. Praesent vestibulum mattis leo, at laoreet sapien egestas quis. Donec viverra feugiat sapien vitae porttitor.</p>
